    ...
    try {
      ...
      teachers.value = rows.map(r => {
        ...
        return {
          ...
          academicRank: (t.teacher && (t.teacher.AcademicDegree?.academic_degree_name || t.teacher.academic_degree_name || t.teacher.academic_rank || t.teacher.academic_degree_id)) || null,
          position: (t.teacher && (t.teacher.position_name || t.teacher.position_id)) || null,
            // personal fields
