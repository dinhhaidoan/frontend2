...
const routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'staff-courses', name: 'staff-courses', component: () => import('../pages/FrameworkSubject-Staff/Courses.vue').catch(() => Fallback), meta: { title: 'Quản lý môn học', subtitle: 'Quản lý môn học từ chương trình đào tạo', menu: { id: 'staff-courses', label: 'Quản lý môn học', icon: 'fas fa-book' } } },
      { path: 'staff-academic-years', name: 'staff-academic-years', component: () => import('../pages/AcademicYear-Staff/AcademicYears.vue').catch(() => Fallback), meta: { title: 'Khóa & Học kỳ', subtitle: 'Quản lý khóa học và học kỳ', menu: { id: 'staff-academic-years', label: 'Khóa & Học kỳ', icon: 'fas fa-calendar-alt' } } },
...
const ids = [
  'curriculum','today-lessons','assignments','materials','forum','ai-tutor',
  'lesson-management','assignment-management','grading','materials-management','coding-demo','ai-assistant',
  'student-management','teacher-management','course-management','curriculum-management','reports','department-forum','ai-management',
