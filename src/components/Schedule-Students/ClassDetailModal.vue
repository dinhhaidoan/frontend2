    ...
    <div v-if="classData" class="modal-overlay" @click.self="close">
      <div class="modal-container">
        ...
        <div class="modal-body">
          ...
          <div class="info-section">
            ...
            <div class="info-grid">
              <div class="info-item">
                ...
                <span class="value">{{ classData.name || classData.class }}</span>
              </div>
              <div class="info-item">
          ...
          <!-- Time Info -->
          <div class="info-section">
            <div class="section-title">Thời gian học</div>
            <div class="info-grid">
              <div class="info-item">
              ...
              <div class="info-item">
                ...
                <span :class="['badge', classData.type]">
                  {{ getTypeText(classData.type) }}
                </span>
              </div>
            </div>
          </div>
